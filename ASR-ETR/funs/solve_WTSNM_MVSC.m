function [Z,E,F,Z_hat,converge_Z,converge_Z_G] = solve_WTSNM_MVSC(X,nC,alpha,lambda,beta,mi,yita)
...
%% ============================== Upadate Z^k =============================
      ...
      for k =1:nV
          tmp = X{k}'*Y{k} + mu*X{k}'*X{k} +  rho*J{k}- mu*X{k}'*E{k} - W{k} -(alpha/nV)*tem_P ;
