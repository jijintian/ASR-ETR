function [Z,E,F,Z_hat,converge_Z,converge_Z_G] = solve_problem(X,nC,alpha,lambda,yita)
...
%         J_tensor = reshape(j, sX);
                ...
                J_tensor = solve_G(Z_tensor + 1/rho*W_tensor,rho,sX,yita);
                j = J_tensor(:);
%% ============================== Upadate W ===============================
        w = w + rho*(z - j);
